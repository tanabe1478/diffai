...
function App() {
  ...
  const completeReview = () => { if (!proposals.length || reviewedCount !== proposals.length) return; ws.current?.send(JSON.stringify({ type: "complete_review", comments, feedback })); };
